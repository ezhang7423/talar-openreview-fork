...
from utils.model_utils import load_baseline_model, load_language_abstract_translator, load_mlp_translator
...
class LangGCPExtractor(BaseFeaturesExtractor):
    def __init__(self, observation_space: gym.Space,
        ...
        if self.language_model.coordinate_dim == 30:
            self._features_dim = 46 # for kitchen
        else:
            self._features_dim = 38 # for ball
